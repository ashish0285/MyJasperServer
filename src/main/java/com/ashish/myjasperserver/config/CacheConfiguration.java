package com.ashish.myjasperserver.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MyJasperServer");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MyJasperServer");
        ...
        config.getMapConfigs().put("com.ashish.myjasperserver.domain.*", initializeDomainMapConfig(jHipsterProperties));
